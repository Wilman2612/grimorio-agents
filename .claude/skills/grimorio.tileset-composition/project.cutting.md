...
notation in ref:skill/grimorio.tileset-composition/project.workflow.md (BorisTheBrave classification), where allowing rotation drops a 16-tile vertex-based
