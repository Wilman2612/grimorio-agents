...
even start" answer — the other files in this skill (ref:skill/grimorio.tileset-composition/project.cutting.md, ref:skill/grimorio.tileset-composition/project.autotiling.md, ref:skill/grimorio.tileset-composition/project.elevation.md, ref:skill/grimorio.tileset-composition/project.layering.md)
...
elevation semantics in particular vary by engine/asset (see ref:skill/grimorio.tileset-composition/project.elevation.md). The only ground truth is the actual
...
Measure the sheet's pixel dimensions; divide by a candidate tile size (8/16/32/64 px — see ref:skill/grimorio.tileset-composition/project.cutting.md for the
...
align a grid overlay to level geometry (see ref:skill/grimorio.tileset-composition/project.cutting.md's grid-finding method).
...
ref:skill/grimorio.tileset-composition/project.coherence.md's "decompose into reusable parts," applied at the cell-symmetry level rather than the
...
Take the candidate center cell, place it in a 3×3 grid (see ref:skill/grimorio.tileset-composition/project.cutting.md for full procedure), and inspect all
...
ref:skill/grimorio.tileset-composition/project.autotiling.md) → paint each terrain type across the sheet's corners/edges (a 3×3 sub-tile grid within each cell
