---
name: grimorio.development-patterns
...
For a Go or Python service, this skill does NOT apply — follow ref:skill/grimorio.golang or ref:skill/grimorio.python instead:
...
> **Related skill**: ref:skill/grimorio.javascript covers language-level standards (naming, async, formatting, SOLID). This skill covers **architectural patterns**: ref:skill/grimorio.javascript tells you *how to write the code*, this skill tells you *where to put it and how to wire the layers*.
>
