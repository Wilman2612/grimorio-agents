...
flecs's prefab manual closes the loop between this file and ref:skill/grimorio.game-patterns/project.type-object-and-data-templates.md:
...
| You need bulk throughput over many homogeneous entities, and profiling says so | SoA / archetype storage (see ref:skill/grimorio.game-patterns/project.data-oriented-design.md) |
