---
name: grimorio.documentation-memory
...
| Kind | Owner |
|---|---|
| Architecture **in use** (structure, why, how pieces combine) | ref:skill/grimorio.architect-memory (architect) |
| Product decisions **in use** (offering, economy, categories) | ref:skill/grimorio.po-memory (PO) |
| Dev traps (hard libraries, gotchas hit while building) | ref:skill/grimorio.developer-memory (developer) |
