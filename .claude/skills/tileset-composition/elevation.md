...
to ref:skill/tileset-composition/layering.md (the general draw-order/compositing toolbox this file's stacking families draw from).
...
via 24×24 mini-tile composition (see ref:skill/tileset-composition/autotiling.md); the "top" (grass rim) draws over it via category order,
not a real Z. This engine has NO native vertical-offset property — see ref:skill/tileset-composition/layering.md's "engines without a native
...
-> This project's ENGINE choice (Family A applies) and the VERIFIED elevation model for our specific tileset:
   ref:skill/tileset-composition/project.md.
