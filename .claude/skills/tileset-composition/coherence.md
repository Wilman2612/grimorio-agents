...
tile. (This is the same transparent-overlay primitive documented in ref:skill/tileset-composition/layering.md, applied here specifically to
...
cleanly on all four sides (seam test, see ref:skill/tileset-composition/cutting.md), but the internal pattern (e.g. wave lines in sand) can
...
intentional asymmetry inverts visibly wrong when mirrored (see ref:skill/tileset-composition/workflow.md's symmetric-vs-unique
...
## Shadow as a coherence + depth cue for props/characters (distinct from cliff shadow — see ref:skill/tileset-composition/elevation.md)
