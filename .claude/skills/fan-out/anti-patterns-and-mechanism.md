...
Split out of ref:skill/fan-out/SKILL.md#part-1--decompose-spawn-in-parallel-synthesize under `CLAUDE.md` rule 23
...
| Letting the fleet inherit the caller's model | dozens of expensive calls on grunt work → session budget gone (see ref:skill/agent-tiers#the-orchestration-cascade-cost-discipline--enforce-it) |
...
-> Back to the operative rules these support: ref:skill/fan-out/SKILL.md.
