...
Sibling to ref:skill/prompt-writing-quality/control-flow-vocabulary.md. That file holds what each
...
belongs in) is a separate question and stays in ref:skill/agent-writing. Read the sibling SKILL.md section when
...
ref:skill/agent-writing/cold-store.md — the manifest maps every handle to a live path or a
...
ref:skill/fan-out#part-1--decompose-spawn-in-parallel-synthesize, ref:skill/agent-tiers#the-one-rule, and this skill itself are each loaded by many agents, and the
...
ref:skill/agent-writing#the-export-boundary-is-the-generalproject-line-ceo-ruling-2026-08-04-translated → "The export boundary is the general/project line" — grimorio exports the behavior
