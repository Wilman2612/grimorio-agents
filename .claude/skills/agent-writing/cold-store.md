...
| handle | target | what |
|---|---|---|
| `vision-game1-history` | `.claude/skills/po-memory/vision-archive/game-1.md` | GAME 1: the revision chains, experiment write-ups and superseded rulings moved out of the live vision |
| `vision-game2-history` | `.claude/skills/po-memory/vision-archive/game-2.md` | GAME 2: how the thesis and the chat mode reached their current wording |
| `vision-index-history` | `.claude/skills/po-memory/vision-archive/register.md` | The vision index's own history, and the closed contradiction register |
| `vision-shared-history` | `.claude/skills/po-memory/vision-archive/shared.md` | Shared foundations and the orchestration surface: what was moved out of both |
| `vision-systems-history` | `.claude/skills/po-memory/vision-archive/systems.md` | Systems (ranking, editor, model catalog, map surface, match modes): the superseded record |
| `agent-writing-levels-history` | `.claude/skills/agent-writing/archive.md` | The pre-2026-07-17 behavior model and the L0/L1/L2/L3 → behavior/general/project/code rename |
