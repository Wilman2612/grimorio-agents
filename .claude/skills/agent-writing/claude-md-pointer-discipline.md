...
This is a companion to import:skill/agent-writing#the-split-principle--the-agent-is-who-it-is-the-skill-is-what-it-does. Read it before adding, editing, or auditing any entry in `CLAUDE.md`.
...
Prose alone cannot enforce a precondition: the ref:skill/agent-selection#hard-rules-of-invocation-mirrored-as-triggers-in-claudemd--agent-selection rule was stated in `CLAUDE.md` AND
