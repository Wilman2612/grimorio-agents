...
- **Judge with an automated visual-comparison critic** (if the project defines one:
...
-> The reference-gathering step that must precede all of this: ref:skill/grimorio.agent-selection#reference-first-for-visual--aesthetic-deliverables-weak-domain-compensation-hard-rule → "REFERENCE-FIRST for
