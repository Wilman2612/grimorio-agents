...
Split out of import:skill/grimorio.agent-writing#2-identity-paragraph → "### 2. Identity paragraph" (PLAN 5.2, 2026-08-03) under
...
the same defence. The conclusion-refutation defence exists — ref:skill/grimorio.agent-writing/system-keeper-behavior.md
...
(this project's own CEO-corrections ledger, "Let a constraint WE
