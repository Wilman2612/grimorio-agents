...
This is a companion to import:skill/grimorio.agent-writing#quality-standards-for-agents → "Quality Standards for Agents" → "Currency". Currency governs a
...
in ref:skill/grimorio.solution-architecture/behavior.md — a design that lived nowhere but a context that later got reset.
...
import:skill/grimorio.agent-writing#reference-depth-dont-hyper-compress--a-skill-can-and-should-have-many-reference-files → "Reference depth, don't hyper-compress — a skill can (and should) have MANY reference
