...
| 5 | child's report → the principal | The child's claim is relayed in the main loop's voice and becomes "the principal said." *"Decía: ah, tú me dijiste que lo hiciera — y yo jamás. Y eso se terminaba esparciendo por todos lados."* | **OPEN — no mechanism**, only the if-you-cannot-quote-him rule |
