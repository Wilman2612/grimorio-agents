...
> instruction above. Everything else on this page is the general mechanism, unchanged.

[One paragraph: what this product IS, who it is for, and the one line that captures its core loop or value
proposition. Point to your own product-memory skill for the vision, decisions, and what's already built —
`project.md` is the index, a features ledger is the record of what EXISTS.]
